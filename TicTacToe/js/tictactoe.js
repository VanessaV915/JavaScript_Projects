...
function placeXOrO(squareNumber) {
    ...
    //see if it conains the square number clicked on.
...
function checkWinConditions() {
    ...
    //O 6, 7, 8 condition.
    else if (arrayIncludes('0O', '6O', '8O')) { drawWinLine(50, 508, 558, 508); }
    // O 0, 3, 6 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        //This line indicates where the end of al ines x axis is.
        y2 = coordY2,
    ...
    //This functions clear our canvas after our win line is drawn.
    function clear() {
