...
// this modifies values ewach time a button is clicked
function Input_Digit(digit) {
    const { Display_Value, Wait_Second_Operand } = Calculator;
    // we are checking to see if Wait_Second_Operand is true and set
    // Display_Valu to the key that was clicked.
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        // in the Perform_Calculation object and the function that mathces the
